      ...
      {!preview ? (
        ...
        >
          <div className="flex flex-col items-center justify-center space-y-3">
            <div
              className={`rounded-full ${error ? "bg-red-100" : "bg-muted"} p-3`}
            >
              {error ? (
                <LuLoaderCircle className="h-6 w-6 text-red-500" />
              ) : (
                <LuUpload className="h-6 w-6 text-muted-foreground" />
              )}
            </div>
            ...
            >
              <LuImage className="mr-2 h-4 w-4" /> Select Image
            </Button>
          </div>
          <input
            type="file"
